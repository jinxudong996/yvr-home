<template>
  <div style="background: #000;">
    ...
    <div class="w1700">
      <div class="mrXzLyTop">
        <div class="mrXzLyMk">
          ...
          <div class="mrXzLyMkPos wow fadeInUp">
            <div class="f79 mrXzLyMkPos_2 bolder mrjbs">真 8K<br>
              IMAX 级空间计算机</div>
          ...
          <div class="mrXzLyMkPosBot">
            <div class="f41 mrXzLyMkPosIcoList wow fadeInUp">
              <ul class="hp mrXzLyMkPosIcoListUl">
                <li><span>·</span>真8K超高清</li>
                <li><span>·</span>DCI-P3 92%广色域</li>
                <li><span>·</span>逐台系统级显示校准</li>
                <li><span>·</span>DTS 模拟7.1声道空间音效</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div class="mrXzLyTop_2">
        ...
        <div class="mrXzLyMk">
          ...
          <div class="mrXzLyMkPos topSmall wow fadeInUp">
            <div class="f68 mrXzLyMkPos_2 bolder mrjbs">AI+MR多屏办公</div>
      ...
      <div class="mrXzLyTop mt35B">
        <div class="mrXzLyMk">
          ...
          <div class="mrXzLyMkPos wow fadeInUp">
            ...
            <div class="f41 mrXzLyMkPosIcoList mt30">
              <ul class="mrXzLyMkPosIcoListUl">
                <li><span>·</span>全新第二代骁龙XR2+芯片</li>
              </ul>
              <ul class="hp mrXzLyMkPosIcoListUl">
                <li><span>·</span>丰富MR+VR游戏</li>
                <li><span>·</span>无光环振动手柄</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="mrXzLyTop_3Left">
          <div class="mrXzLyMk">
            ...
            <div class="mrXzLyMkPos topBig wow fadeInUp">
              <div class="f68 mrXzLyMkPos_2 bolder mrjbs">多模态手眼语音交互</div>
          ...
          <div class="mrXzLyMk">
            ...
            <div class="mrXzLyMkPos topBig wow fadeInUp">
              ...
              <div class="f41 mrXzLyMkPos_1">虚实切换</div>

              <div class="f41 mrXzLyMkPosIcoList mt30">
                <ul class="hp mrXzLyMkPosIcoListUl">
                  <li><span>·</span>14ms低延迟彩色透视</li>
                  <li><span>·</span>空间多屏</li>
                  <li><span>·</span>空间组件</li>
                  <li><span>·</span>MR旋钮</li>
                </ul>
              </div>
            </div>
          </div>
    ...
    <div class="w1700 mrJmYy">
      ...
      <div class="f110 bolder mrJmYy_4 wow fadeInUp">DTS 模拟7.1声道<br>
        空间音效</div>
    ...
    <ul class="mrSbXzLb w1700">
      <li>
        <div class="f72 bolder mrjbs">8K</div>
        <p class="f44">超高清</p>
      </li>
      <li>
        <div class="f72 bolder mrjbs">DCI-P3 92%</div>
        <p class="f44">广色域<span class="jb">1</span></p>
      </li>
      <li>
        <div class="f72 bolder mrjbs">3882 <em class="f44">PPI</em></div>
        <p class="f44">像素密度<span class="jb">2</span></p>
      </li>
      <li>
        <div class="f72 bolder mrjbs">注视点渲染</div>
        <p class="f44">实时</p>
      </li>
    </ul>
    ...
    <div class="w1700">
      <div class="f110 bolder mrJmYy_4 wow fadeInUp">空间计算机逐台显示校准</div>
      <div class="f60 mrJmYy_2 wow fadeInUp">逐台使用双屏校色算法平衡左右屏幕亮度、色温, 进行颜色校准, 实现色准 dE<3 ；逐台进行几何标定, 去除畸变, 降低眩晕, 实现双目合像误差
          <0.01° <span class="jb">5</span></div>
    </div>
    ...
    <div class="w1700">
      ...
      <div class="f60 mrJmYy_2 sbXzIco wow fadeInUp"><img src="../assets/images/mr/ico14.png" alt="" />与德国莱茵 TÜV 合作,
        严格符合 TÜV 低蓝光护眼标准。
      </div>
    </div>
    <div class="mrJmYy_12">
      <div class="mrJmYy_12Pos w1700">
        <ul>
          <li>
            <div class="f40 mrJmYy_2 wow fadeInUp"><div><img src="../assets/images/mr/ico15.png" alt="" /></div>智能防蓝光护眼模式
            </div>
          </li>
          <li>
            <div class="f40 mrJmYy_2 wow fadeInUp"><div><img src="../assets/images/mr/ico16.png" alt="" /></div>多档亮度可调节
            </div>
          </li>
        </ul>
      </div>
    ...
    <div class="w1700 mrJmYy_14">
      ...
      <div class="f110 bolder mrJmYy_4 wow fadeInUp">观看3D空间视频<br>
        EIS立体防抖大显身手</div>
      ...
      <div class="f110 bolder mrJmYy_4 wow fadeInUp">3D空间视频美颜 <span class="jb">7</span> </div>
      ...
      <div class="mrJmYy_17 wow fadeInUp">
        ...
        <ul class="mrJmYy_17List">
          <li class="f44"><div class="mrJmYy_17List_1"><img src="../assets/images/mr/ico5.png" alt="" /></div><div class="mrJmYy_17List_2">独创支持VR180格式<br>3D 视频拍摄</div></li>
          <li class="f44"><div class="mrJmYy_17List_1"><img src="../assets/images/mr/ico6.png" alt="" /></div><div class="mrJmYy_17List_2">业内创新一体机拍摄<br>3D 全景照片</div></li>
        </ul>
      </div>
    </div>
    <div class="mrJmYy_13">
    ...
    <div class="w1700 mrJmYy_14">
      ...
      <div class="f147 bolder mrjbs mrJmYy_19 wow fadeInUp">14ms低延迟彩色透视<br>
        1:1还原真实物理空间</div>
      <div class="mrJmYy_20">
        <div class="mrJmYy_20Left wow fadeInUp">
    ...
    <div class="w1700 mrJmYy_14">
      ...
      <ul class="sbGsGt ">
        <li>
          ...
          <div class="f44 sbGsGt_2">游戏新体验</div>
        </li>
        <li>
          <div class="mrjbs f61 sbGsGt_1 bolder">VR</div>
          <div class="f44 sbGsGt_2">游戏大作</div>
        </li>
        <li>
          <div class="mrjbs f61 sbGsGt_1 bolder">2D游戏</div>
          <div class="f44 sbGsGt_2">大屏畅玩</div>
        </li>
      </ul>
    ...
    <div class="mrJmYy_23">
      ...
      <div class="w1700 mrJmYy_23Pos">
        <div class="f60 mrJmYy_2 wow fadeInUp">第二代骁龙XR2+芯片, 大幅提升数据和图形处理能力, 储存更及时, 无惧大内存运行。</div>

        <div class="">
          <ul class="mrSbXzLb w3">
            <li>
              <div class="f72 bolder mrjbs">↑2.5倍</div>
              <p class="f44">GPU性能</p>
            </li>
            <li>
              <div class="f72 bolder mrjbs">↑8倍</div>
              <p class="f44">AI性能表现</p>
            </li>
            <li>
              <div class="f72 bolder mrjbs">↑50%<span class="jb">12</span></div>
              <p class="f44">GPU功耗比</p>
            </li>
            <li>
              <div class="f72 bolder mrjbs">16G</div>
              <p class="f44">内存</p>
            </li>
            <li>
              <div class="f72 bolder mrjbs">512GB/1T</div>
              <p class="f44">存储空间<span class="jb">13</span></p>
            </li>
          </ul>
        </div>
    ...
    <div class="w1700 rhJxNr wow fadeInUp">
      ...
      <div class="f60 colorfff rhJxNr_222">荣获红点设计奖</div>
    </div>
    <div class="w1700 qbHkNr">
      ...
      <div class="f110 bolder mrjbs_2 mrJmYy_4 wow fadeInUp">多终端空间互联, <br>
        全面适配</div>
      ...
      <div class="f38 bzNr_2 wow fadeInUp">
        <p>1.数据来自屏幕厂商规格</p>
        <p>2.数据来自屏幕厂商规格，基于玩出梦想MR和YVR2 产品的对比</p>
        <p>3.数据来自玩出梦想实验室，基于玩出梦想MR和YVR2 产品的对比</p>
        <p>4.数据来自玩出梦想实验室</p>
        <p>5.数据来自玩出梦想实验室</p>
        <p>6.数据来自玩出梦想实验室</p>
        <p>7.3D智能美颜待后续OTA更新</p>
        <p>8.AI角色大师待后续OTA更新</p>
        <p>9.AI360全景图片补全待后续OTA更新</p>
        <p>10.3D生成器待后续OTA更新</p>
        <p>11.3D空间组件待OTA更新</p>
        <p>12.数据来自高通官方实验室，基于高通骁龙XR2+ Gen1的对比</p>
        <p>13.存储容量为512GB版与1TB版，请根据需要选择规格</p>
        <p>14.数据来自玩出梦想实验室，基于内置电池+外接充电宝供电方案，对沉浸式游戏场景进行测试的结果。</p>
        <p>15.产品采用双电池串联设计，等效于5060mAh（3.88V) , 19.6Wh电池容量</p>
        <p>16.产品采用双电池串联设计，等效于10000mAh（3.7V) , 37Wh电池容量</p>
      </div>
    </div>
