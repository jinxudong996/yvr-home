  ...
  <div>
    ...
    <div class="allNyBan" :style="allNyBanBg">
      ...
      <div class="allNyBanPos">
        <div class="f52 bolder colorfff textCenter allNyBanPosTit_1 wow fadeInUp">Join <span
            class="counter">50,000</span>+ Players in Exploring Endless Possibilities</div>
      </div>
      <div class="llMoreNr">
        ...
        <div class="w1335 serNyConMkNr">
          <div class="serNyConMkNrLeft wow fadeInUp">
            ...
            <div class="serNyConMkNrLeft_3">
              <div class="allBtn addBk"><a :href="serviceVoList0.downloadUrl" target="_blank">Download
                  Now<span>&nbsp;</span></a></div>
              <!-- <div class="allBtn addBk goToDetail"><a href="javascript:void(0);">Learn More<span>&nbsp;</span></a></div> -->
            </div>
          </div>
      ...
      <div class="serNyConMk serNyConMk_1" :style="serNyConMkBg1">
        <div class="w1335 serNyConMkNr">
          <div class="serNyConMkNrLeft wow fadeInUp">
            ...
            <div class="serNyConMkNrLeft_3">
              <div class="allBtn addBk"><a :href="serviceVoList1.downloadUrl" target="_blank">Download
                  Now<span>&nbsp;</span></a></div>
              <div class="allBtn addBk goToDetail"><a href="javascript:void(0);">Learn More<span>&nbsp;</span></a></div>
            </div>
          </div>
        ...
        <div class="w1335 serNyConMkNrXq">
          <div class="serNyConMkNrXqCon">
            ...
            <div class="f16 xzFwBot">
              <div class="xzFwBot_1 f20"><a download="/static/doc/YVR串流助手使用指南.docx" href="/static/doc/YVR串流助手使用指南.docx"
      ...
      <div class="serNyConMk serNyConMk_2" :style="serNyConMkBg2">
        <div class="w1335 serNyConMkNr">
          <div class="serNyConMkNrLeft wow fadeInUp">
            ...
            <div class="serNyConMkNrLeft_3">
              <div class="allBtn addBk"><a :href="serviceVoList2.downloadUrl" target="_blank">Download
                  Now<span>&nbsp;</span></a></div>
              <div class="allBtn addBk goToDetail"><a href="javascript:void(0);">Learn More<span>&nbsp;</span></a></div>
            </div>
          </div>
        ...
        <div class="w1335 serNyConMkNrXq">
          <div class="serNyConMkNrXqCon">
            ...
            <div class="f16 xzFwBot">
              <div class="xzFwBot_1 f20"><a download="/static/doc/YVR飞屏助手使用指南.docx" href="/static/doc/YVR飞屏助手使用指南.docx"
                  target="_blank">Download the Film Stream Assistant User Guide ⬇️</a></div>
              <div class="xzFwBot_2">
                <p>1. Download and install Film Stream Assistant. Then, open the app and add videos.</p>
                <p>2. Ensure that your devices and PC are connected to the same network. Then, click Search for Device by using the device and select your PC.</p>
