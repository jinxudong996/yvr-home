  ...
  <div>
    ...
    <div class="allNyBan" :style="leftBg">
      ...
      <div class="allNyBanPos">
        <div class="f52 bolder colorfff textCenter allNyBanPosTit_1 wow fadeInUp">Brand dynamics</div>
        <div class="f24 colorfff textCenter wow fadeInUp allNyBanPosTit_2">Learn about the latest brand hot news</div>
      </div>
      <div class="llMoreNr">
        <p class="llMoreNr_1">Scroll Down to View More</p>
    ...
    <div class="w1600 newsZy">
      <div class="newsZyTit wow fadeInUp"  v-show="headlineList.length>0">
        <div class="f52 bolder newsZyTit_1">Latest News</div>
                ...
                <div class="newsZySwiperNrLeftCon ani" swiper-animate-effect="fadeInUp" swiper-animate-duration="0.5s">
                  ...
                  <div class="newsZySwiperNrLeft_5">
                    <div class="allBtn addBk" @click="jumpDetail(item, index)"><a
                        href="javascript:void(0);">Learn More<span>&nbsp;</span></a></div>
                  </div>
                </div>
              </div>
