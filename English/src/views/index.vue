  ...
  <div>
    ...
    <div class="sjxxFsDypWc" style="position: relative;width: 100%;">
                ...
                <div class="ani" swiper-animate-effect="fadeInUp" swiper-animate-duration="0.5s">
                  <div class="sjxxFsDypCon_2">
                    <div class="allBtn active"><a href="https://live.bilibili.com/25397624"
                        target="_blank">Watch live<span>&nbsp;</span></a></div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="sjxxFsDyp-pagination">
        <span class="swiper-pagination-customs" v-for="(item, index) in bannerVoList1" :key="index * 1.1111111">0{{
          item.id }}<span>&nbsp;</span></span>
      </div>
    </div>
          ...
          <div class="w_1760 wcmxDepCon">
            <div class="ani" swiper-animate-effect="fadeInUp" swiper-animate-duration="0.5s">
              ...
              <div class="wcmxDepCon_3">
                <div class="allBtn active"><a href="javascript:void(0);" @click="showMc">Book now<span>&nbsp;</span></a>
                </div>
                <div class="allBtn"><router-link to="/mr">Explore More<span>&nbsp;</span></router-link></div>
              </div>
            </div>
          </div>
        </div>
  ...
  async mounted() {
    ...
    $(function () {
      ...
      $(".sjxxFsDyp-pagination .swiper-pagination-customs").click(function () {
        ...
        $(".sjxxFsDyp-pagination .swiper-pagination-customs").removeClass('swiper-pagination-customs-active');
