<template>
  <div style="background: #000;">
    ...
    <div class="w1700">
      ...
      <div class="mrXzLyTop_2">
          ...
          <div class="mrXzLyMkPos topSmall wow fadeInUp">
            ...
            <div class="f41 mrXzLyMkPosIcoList mt30">
              <ul class="mrXzLyMkPosIcoListUl">
                ...
                <li><span>·</span>3D Spatial Video Beautification</li>
        ...
        <div class="mrXzLyMk">
          ...
          <div class="mrXzLyMkPos topSmall wow fadeInUp">
            <div class="f68 mrXzLyMkPos_2 bolder mrjbs">AI+MR Multiscreen Workspace
            </div>
      ...
      <div class="mrXzLyTop mt35B">
        <div class="mrXzLyMk">
          ...
          <div class="mrXzLyMkPos wow fadeInUp">
            ...
            <div class="f41 mrXzLyMkPosIcoList mt30">
              <ul class="mrXzLyMkPosIcoListUl">
                <li><span>·</span>Snapdragon XR2+ Gen 2 Chip</li>
              </ul>
              <ul class="hp mrXzLyMkPosIcoListUl">
                <li><span>·</span>Extensive MR and VR game library</li>
                <li><span>·</span>Halo-Free Vibrating Controllers</li>
              </ul>
            </div>
          </div>
        </div>
      </div>
      <div class="mrXzLyTop_3">
        <div class="mrXzLyTop_3Left">
          <div class="mrXzLyMk">
            <img class="img100" src="../assets/images/mr/img5.png" alt="" />
            <div class="mrXzLyMkPos topBig wow fadeInUp">
              <div class="f68 mrXzLyMkPos_2 bolder mrjbs">Multimodal Hand-Eye-Voice Interaction</div>
          ...
          <div class="mrXzLyMk">
            ...
            <div class="mrXzLyMkPos topBig wow fadeInUp">
              ...
              <div class="f41 mrXzLyMkPosIcoList mt30">
                <ul class="hp mrXzLyMkPosIcoListUl">
                  <li><span>·</span>14ms Low-Latency Color passthrough</li>
            ...
            <div class="mrXzLyMkPos topBig wow fadeInUp">
              ...
              <div class="f41 mrXzLyMkPosIcoList mt30">
                <ul class="mrXzLyMkPosIcoListUl">
                  ...
                  <li><span>·</span>3：2 Balanced weight distribution</li>
                </ul>
              </div>
            </div>
          </div>
    ...
    <div class="mr8K">
      ...
      <div class="w1700 mr8KTit">
        <div class="f177 bolder mrjbs wow fadeInUp">
          True 8K<br>IMAX-Level Theater Experience
        </div>
      </div>
    ...
    <div class="w1700 mrJmYy">
      ...
      <div class="f110 bolder mrJmYy_4 wow fadeInUp">DTS Simulated 7.1 Channel Spatial Sound Effect</div>
    ...
    <ul class="mrSbXzLb w1700">
      <li>
        <div class="f72 bolder mrjbs">Dual 8K</div>
        <p class="f44">True 8K Ultra HD</p>
      </li>
      <li>
        <div class="f72 bolder mrjbs">DCI-P3 92% </div>
        <p class="f44">Wide Color Gamut<span class="jb">1</span></p>
      </li>
      <li>
        <div class="f72 bolder mrjbs">3882<em class="f44">PPI</em></div>
        <p class="f44">Pixel Density<span class="jb">2</span></p>
      </li>
      <li>
        <div class="f72 bolder mrjbs">Foveated Rendering</div>
        <p class="f44">Real-time</p>
      </li>
    </ul>
    ...
    <div class="w1700">
      ...
      <div class="f72 mrJmYy_9 wow fadeInUp">
        <span>45 Center PPD <img src="../assets/images/mr/ico12.png" alt="" /></span>
        <span>Dual-Eye FOV <img src="../assets/images/mr/ico13.png" alt="" /></span>
      </div>
    </div>
    ...
    <div class="w1700">
      ...
      <div class="f60 mrJmYy_2 sbXzIco wow fadeInUp"><img src="../assets/images/mr/ico14.png" alt="" />In collaboration
        with TÜV Rheinland from Germany, strictly adhering to TÜV
        low blue light eye protection standards.
      </div>
    </div>
    <div class="mrJmYy_12">
      <div class="mrJmYy_12Pos w1700">
        <ul>
          <li>
            <div class="f40 mrJmYy_2 wow fadeInUp">
              <div><img src="../assets/images/mr/ico15.png" alt="" /></div>Smart Blue Light Protection Mode
            </div>
          </li>
          <li>
            <div class="f40 mrJmYy_2 wow fadeInUp">
              <div><img src="../assets/images/mr/ico16.png" alt="" /></div>Multiple Adjustable Brightness Levels
            </div>
          </li>
        </ul>
      </div>
      <img class="img100" src="../assets/images/mr/img18.png" alt="" />
    </div>
    <div class="mrJmYy_13">
    ...
    <div class="w1700 mrJmYy_14">
      ...
      <div class="f110 bolder mrJmYy_4 wow fadeInUp">3D Spatial Video Beautification <span class="jb">7</span> </div>
      ...
      <div class="mrJmYy_17 wow fadeInUp">
        <!-- <img class="img100" src="../assets/images/mr/img46.png" alt="" /> -->
        <ul class="mrJmYy_17List">
          <li class="f44"><div class="mrJmYy_17List_1"><img src="../assets/images/mr/ico5.png" alt="" /></div><div class="mrJmYy_17List_2">Uniquely supports VR180 format<br>3D video shooting</div></li>
          <li class="f44"><div class="mrJmYy_17List_1"><img src="../assets/images/mr/ico6.png" alt="" /></div><div class="mrJmYy_17List_2">Industry-leading innovative all-in-one device for shooting<br>3D panoramic photos</div></li>
        </ul>
      </div>
    </div>
    <div class="mrJmYy_13">
      ...
      <div class="aiBqNr mt30">
        <div class="aiBqNrMk">
          ...
          <div class="aiBqNrMkPos wow fadeInUp">
            ...
            <div class="f45 aiBqNrMkPos_2">3D Generator <span class="jb">10</span>: Quickly convert 2D images into 3D resources, allowing you to
    ...
    <div class="w1700 mrJmYy_14">
      ...
      <div class="mrJmYy_20">
        <div class="mrJmYy_20Left wow fadeInUp">
          <div class="f60 mrJmYy_20Left_1">Place 3D spatial components at specific locations<span class="jb">11</span>, including clocks, weather
      ...
      <div class="f147 bolder mrjbs mrJmYy_19 wow fadeInUp">14ms Low-Latency Color passthrough<br>
    ...
    <div class="w1700 mrJmYy_14">
      ...
      <ul class="sbGsGt ">
        <li>
          <div class="mrjbs f61 sbGsGt_1 bolder">MR</div>
          <div class="f44 sbGsGt_2">Game New Experience</div>
        </li>
        <li>
          <div class="mrjbs f61 sbGsGt_1 bolder">VR</div>
          <div class="f44 sbGsGt_2">AAA Games</div>
        </li>
        <li>
          <div class="mrjbs f61 sbGsGt_1 bolder">2D Games</div>
          <div class="f44 sbGsGt_2">on a Large Screen</div>
        </li>
      </ul>
      <div class="f140 bolder mrjbs mrJmYy_1 mrJmYy_22 wow fadeInUp">
        Snapdragon XR2+ Gen 2 Chip<br>
        Powerful Performance, Immersive Audio-Visual Experience
      </div>
    </div>
    <div class="mrJmYy_23">
      <img class="img100" src="../assets/images/mr/img36.png" alt="" />
      <div class="w1700 mrJmYy_23Pos">
        <div class="f60 mrJmYy_2 wow fadeInUp">Snapdragon XR2+ Gen 2 Chip significantly enhances data and graphics
          processing
          capabilities, ensuring timely storage and smooth operation even with large memory demands.</div>

        <div class="">
          <ul class="mrSbXzLb w3">
            <li>
              <div class="f72 bolder mrjbs">↑2.5x Increase</div>
              <p class="f44">GPU Performance</p>
            </li>
            <li>
              <div class="f72 bolder mrjbs">↑8x Improvement</div>
              <p class="f44">AI Performance</p>
            </li>
            <li>
              <div class="f72 bolder mrjbs">↑50% Better <span class="jb">12</span></div>
              <p class="f44">GPU Power Efficiency</p>
            </li>
            <li>
              <div class="f72 bolder mrjbs">16GB</div>
              <p class="f44">RAM</p>
            </li>
            <li>
              <div class="f72 bolder mrjbs">512GB/1TB</div>
              <p class="f44">Storage<span class="jb">13</span></p>
            </li>
          </ul>
        </div>
      ...
      <div class="nzZgSbPos">
        <div class="w1700">
          ...
          <div class="f60 mrJmYy_2 wow fadeInUp">
            ...
            worry-free play <span class="jb">14</span>. Paired with a fast-charging 45W GaN adapter, enjoy lightweight, easy to carry, and quickly
            recharges anytime.
          </div>
        </div>
      </div>
    ...
    <div class="w1700 rhJxNr wow fadeInUp">
      <div class="f60 colorfff">Winner of Red Dot Design Award</div>
      <div class="rhJxNr_1">
    ...
    <div class="w1700 qbHkNr">
      ...
      <div class="cpCsNrMk wow fadeInUp">
        ...
        <div class="cpCsNrMkRight">
          <div class="f61 cpCsNrMkRight_1">
            <p>Headband Battery Capacity: 5060mAh<span class="jb">15</span></p>
            <p>External Power Bank Battery Capacity: 10000mAh<span class="jb">16</span></p>
      ...
      <div class="f61 bzQdList wow fadeInUp">
        <ul>
          <li>PLAY FOR DREAM MR×1</li>
          <li>Controllers × 2</li>
          <li>Portable power bank × 1</li>
          <li>Fast Charger × 1</li>
          <li>Replaceable magnetic foam (thick) × 1</li>
          <li>Head display data/charging cable × 1</li>
          <li>Dual Type-C (not sure) controller charging cable × 1</li>
          <li>User’s manual × 1</li>
      ...
      <div class="f38 bzNr_2 wow fadeInUp">
        ...
        <p>2. Data provided by the screen manufacturer specifications, based on a comparison between Play For Dream MR
          and YVR2</p>
        <p>3. Data provided by Play For Dream Technology Labs, based on a comparison between Play For Dream MR and YVR2
        </p>
        ...
        <p>14. Data provided by Play For Dream Technology Labs, based on immersive gaming scenarios tested with internal
          battery + external power bank setup.</p>
...
<script>
  ...
  export default {
    ...
    mounted() {
      $(function() {
        $(".allTopConMenu ul li").eq(1).addClass("active");
